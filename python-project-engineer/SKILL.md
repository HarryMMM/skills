...
### 依赖基线
- 核心：`pydantic`、`pydantic-settings`、`SQLAlchemy[asyncio]`、`aiomysql`
...
1. 收集必填信息，应用默认值
2. 创建标准目录结构
3. 从 [assets](./assets/) 生成模板文件（替换占位变量）
4. 生成基础骨架代码
5. 执行验证流程
6. 输出结果与人工复核清单
...
### feature：新特性开发
1. 明确特性目标、输入输出与边界条件
2. 识别影响范围与落点文件（tool/service/repository）
3. 按分层约束实现功能
4. 补充必要测试或最小验证样例
5. 执行验证流程
6. 输出功能变更摘要、风险点与复核清单
...
| [ci-github.yml.template](./assets/ci-github.yml.template) | GitHub Actions CI |
